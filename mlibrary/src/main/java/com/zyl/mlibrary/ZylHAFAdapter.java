 ...
 * <p>
 * 如：
 * ZylAdapter adapter = new ZylAdapter();
 * recyclerView.setAdatper(adapter.getHeaderAndFooterAdapter());
 */
public class ZylHAFAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ZylHAFAdapter(RecyclerView.Adapter innerAdapter) {
